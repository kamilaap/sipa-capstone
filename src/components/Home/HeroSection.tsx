  ...
  return (
    <section className="relative bg-gradient-to-br from-[#F0E7FF] via-[#EAD6FF] to-[#F5EBFF] w-full min-h-screen pt-32 pb-32 px-6 md:px-24 transition-all duration-500 overflow-hidden flex flex-col justify-center">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-10 left-10 w-4 h-4 rounded-full animate-pulse" style={{ backgroundColor: warnaPartikel[0] }}></div>
        <div className="absolute top-1/4 right-1/4 w-8 h-8 rounded-full animate-pulse opacity-40" style={{ backgroundColor: warnaPartikel[1] }}></div>
        <div className="absolute bottom-10 right-10 w-6 h-6 rounded-full animate-pulse" style={{ backgroundColor: warnaPartikel[2] }}></div>
        <div className="absolute bottom-1/3 left-1/5 w-5 h-5 rounded-full animate-pulse opacity-60" style={{ backgroundColor: warnaPartikel[3] }}></div>
        {/* Nambahin 1 partikel lagi buat lebih asik */}
        <div className="absolute top-1/3 left-2/3 w-3 h-3 rounded-full animate-pulse opacity-70" style={{ backgroundColor: warnaPartikel[0] }}></div>
      </div>

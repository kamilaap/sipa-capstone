...
const Pelayanan = () => {
  ...
  const handleSendMessage = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const response = await axios.post(
        'https://api-sipa-capstone-production.up.railway.app/ask-model',
        {
          question: userInput,
        },
        {
  ...
  const handleEndChat = () => {
    ...
    // Tambahkan animasi
    document
      .getElementById('confirm-chat-end')
    ...
    document
      .getElementById('cancel-chat-end')
      ?.addEventListener('click', () => {
        const modalContent = modal.querySelector('div');
        if (modalContent) {
          modalContent.classList.remove('animate-fadeIn');
        ...
        <div className="max-w-md w-full bg-white p-8 rounded-xl shadow-lg">
          <div className="text-center mb-6">
            ...
            <p className="text-gray-600">
              Silakan login terlebih dahulu untuk mengakses layanan chatbot
              kami.
            </p>
          </div>
        ...
        <div className="fixed top-20 inset-x-0 flex justify-center z-50 px-4 animate-fadeIn">
          <div className="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded-lg shadow-md flex items-center max-w-md">
            ...
            <span className="flex-1 text-sm">
              Ada masalah koneksi ke server. Pastikan Anda terhubung ke
              internet.
            </span>
            <button
            ...
            >
              ...
              >
                <div className="flex items-center mb-1">
                  ...
                  <span
                    className={`text-xs ${message.sender === 'user' ? 'text-white/80' : 'text-gray-500'}`}
                  >
                    {message.sender === 'user' ? userName : 'SIPA Assistant'} •{' '}
